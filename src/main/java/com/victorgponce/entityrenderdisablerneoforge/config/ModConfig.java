...
public class ModConfig {
    ...
    private static final File CONFIG_FILE = net.neoforged.fml.loading.FMLPaths.CONFIGDIR.get()
            .resolve(Entityrenderdisablerneoforge.MODID + ".json").toFile();
    ...
    public static void load() {
        try {
            ...
            Entityrenderdisablerneoforge.LOGGER.error("Failed to load config", e);
            entityRenderStates = new HashMap<>();
        }
    }
    ...
    public static void save() {
        try {
            ...
            Entityrenderdisablerneoforge.LOGGER.error("Failed to save config", e);
        }
    }
